...
const preferenceSchema = zod_1.z.discriminatedUnion("type", [
    ...
    zod_1.z
        ...
        default: zod_1.z
            ...
            zod_1.z.string(),
            zod_1.z.object({
                Linux: zod_1.z.string().optional(),
                macOS: zod_1.z.string().optional(),
                Windows: zod_1.z.string().optional(),
            }),
        ])
            .describe("The optional default value for the field. For textfields, this is a string value. Additionally, you can specify a different value per platform by passing an object: { 'Linux': ..., 'macOS': ..., 'Windows': ... }.")
            .optional(),
    })
        .strict(),
    // password preference
    zod_1.z
        ...
        default: zod_1.z
            ...
            .describe("The optional default value for the field. For passwords, this is a string value. Additionally, you can specify a different value per platform by passing an object: { 'Linux': ..., 'macOS': ..., 'Windows': ... }.")
            .optional(),
    })
        .strict(),
    // checkbox preference
    zod_1.z
        ...
        default: zod_1.z
            ...
            zod_1.z.boolean(),
            zod_1.z.object({
                Linux: zod_1.z.boolean().optional(),
                macOS: zod_1.z.boolean().optional(),
                Windows: zod_1.z.boolean().optional(),
            }),
        ])
            .describe("The optional default value for the field. For checkboxes, this is a boolean value. Additionally, you can specify a different value per platform by passing an object: { 'Linux': ..., 'macOS': ..., 'Windows': ... }.")
            .optional(),
    })
        .strict(),
    // dropdown preference
    zod_1.z
        ...
        default: zod_1.z
            ...
            .describe("The optional default value for the field. For dropdowns, this is the value of an object in the data array. Additionally, you can specify a different value per platform by passing an object: { 'Linux': ..., 'macOS': ..., 'Windows': ... }.")
            .optional(),
    })
        .strict(),
    ...
    zod_1.z
        ...
        default: zod_1.z
            ...
            .describe("The optional default value for the field. For appPickers, this is an application name, bundle ID or path. Additionally, you can specify a different value per platform by passing an object: { 'Linux': ..., 'macOS': ..., 'Windows': ... }.")
            .optional(),
    })
        .strict(),
    // file preference
    zod_1.z
        ...
        default: zod_1.z
            ...
            .describe("The optional default value for the field. For file preferences, this is a file path. Additionally, you can specify a different value per platform by passing an object: { 'Linux': ..., 'macOS': ..., 'Windows': ... }.")
            .optional(),
    })
        .strict(),
    ...
    zod_1.z
        ...
        default: zod_1.z
            ...
            .describe("The optional default value for the field. For directory preferences, this is a directory path. Additionally, you can specify a different value per platform by passing an object: { 'Linux': ..., 'macOS': ..., 'Windows': ... }.")
            .optional(),
    })
        .strict(),
]);
...
exports.default = zod_1.z.object({
    ...
    platforms: zod_1.z
        .array(zod_1.z.enum(["Linux", "macOS", "Windows"]))
        .min(1)
        .describe("Platforms where this extension can run. If not present, the extension is assumed to be available on all platforms.")
        .optional(),
    commands: zod_1.z
        .array(zod_1.z
        .object({
